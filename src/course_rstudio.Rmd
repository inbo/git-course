...
Per avere l'indirizzo **HTTPS** di clone della repo é sufficiente cliccare sopra <span style="color: green;">code</span> e premere sul piccolo bottone accanto all'indirizzo per copiare su clipboard (in alternativa seleziona e copia tutto l'url).
