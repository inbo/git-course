...
* tu abbia [R](https://lib.ugent.be/CRAN/) e [Rstudio](https://www.rstudio.com/products/rstudio/download/) installati e funzionanti sul computer.
* tu abbia [git](https://git-scm.com/) installato sul computer e puntanto sul file `git.exe`
* tu abbia un [account GitHub](https://github.com/join), pensaci al tuo nome due secondi in più, è sempre possibile cambiarlo ma incorri nei [seguenti problemi](https://docs.github.com/en/github/setting-up-and-managing-your-github-user-account/changing-your-github-username)
