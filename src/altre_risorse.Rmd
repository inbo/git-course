...
Se vuoi approfondire oltre questo [ecco la documentazione](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions). Sotto ne sono stati creati due dall'autore sulla base di templates gia esistenti per azioni di **Bug Reporting** e di **Pull Request**. Niente vieta che tu ne possa scrivere altri per diverse azioni.
...
Quindi navigando nella cartella del progetto su GitHub e andando nel pane Issues, vediamo due templates che rispondono alle due azioni concesse dall'autore. Immaginiamo di trovare un <span style="color: red;">Bug</span> nel codice e di volerlo segnalare.
Bug Report fa al caso nostro.

![issues template](static/images/bug_report_temp.PNG){width=75%}

E premendo su <span style="color: green;">Get Started</span> 
